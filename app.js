...
const medium = [
  ...
  "차단각이다",
  "이런 건 좀 아닌 듯 — \"{msg}\"", 
  "다시 생각해보는 게 좋지 않을까 — \"{msg}\"", 
  "이거 보고 불편해진 사람 많을 듯 — \"{msg}\"", 
  "왜 굳이 이렇게 말했어? — \"{msg}\"", 
  "너무 무신경하다 — \"{msg}\"", 
  "그냥 넘어갈 수 없는 말이다 — \"{msg}\"", 
  "어쩐지 불쾌하네 — \"{msg}\"", 
  "센스가 부족한 거 아냐? — \"{msg}\"", 
  "조금 더 조심했어야지 — \"{msg}\"", 
  "이건 트윗으로 올리면 욕먹기 딱 좋아 — \"{msg}\"", 
  "민감한 표현 아닌가 — \"{msg}\"", 
  "좋게 보긴 힘들다 — \"{msg}\"", 
  "사람 생각 안 하고 쓴 듯 — \"{msg}\"", 
  "이 말이 무슨 의미로 들릴지 생각 안 해봤어? — \"{msg}\"", 
  "불쾌할 수밖에 없는 트윗 — \"{msg}\"", 
  "아무리 봐도 이상하다 — \"{msg}\"", 
  "웃자고 쓴 거라면 실패 — \"{msg}\"", 
  "타이밍이 안 좋아 — \"{msg}\"", 
...
const strong = [
  ...
  "읽고 분노가 치밀었다 — \"{msg}\"", 
  "절대 용납 못 해 — \"{msg}\"", 
  "SNS에서 이런 말이라니 충격적이다 — \"{msg}\"", 
  "이건 망언 수준 — \"{msg}\"", 
  "차라리 계정 닫는 게 낫겠다 — \"{msg}\"", 
  "누가 봐도 기분 나쁠 말 — \"{msg}\"", 
  "여기까지 선 넘은 건 처음 본다 — \"{msg}\"", 
  "더 심하게 말하고 싶지만 참는다 — \"{msg}\"", 
  "분노 유발 트윗 — \"{msg}\"", 
  "정말 어처구니없다 — \"{msg}\"", 
  "이 트윗은 역사에 남을 듯 — \"{msg}\"", 
  "망언계의 교과서 — \"{msg}\"", 
